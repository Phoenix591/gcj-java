...
LDPATH="\${JAVA_HOME}/jre/lib/$(get_system_arch)/:\${JAVA_HOME}/jre/lib/$(get_system_arch)/native_threads/:\${JAVA_HOME}/jre/lib/$(get_system_arch)/xawt/:\${JAVA_HOME}/jre/lib/$(get_system_arch)/server/"
